...
export default function Hero({
  ...
  return (
    <section className="relative bg-gradient-to-r from-blue-800 via-blue-600 to-cyan-500 text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-20 text-center">
        ...
        <h1 className="text-5xl md:text-6xl font-bold mb-6">
          ...
          <span className="block text-cyan-300">{subtitle}</span>
        </h1>
        <p className="text-xl md:text-2xl text-blue-200 mb-8 max-w-3xl mx-auto leading-relaxed">{description}</p>
